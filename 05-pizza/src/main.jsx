        ...
        {numPizzas > 0 ? (
          <>
            <p>
              ...
              from our stone o ven, all organic, all delicious
            </p>
            <ul className="pizzas">
              {pizzas.map((pizza) => (
          ...
          <p>we are still working on your menu please come later : </p>
        )}
      </main>
    </>
  );
...
function Order({ openHour, closeHour }) {
  return(
    <div className="order">
          <p>we are open from {openHour}:00 to { closeHour}:00. come visit us or order</p>
...
//during development strictmode will render all components twice to find bugs
root.render(
  <React.StrictMode>
    <App />
  </React.StrictMode>
